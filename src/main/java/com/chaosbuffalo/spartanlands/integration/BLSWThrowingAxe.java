 ...
 */
public class BLSWThrowingAxe extends ItemThrowingAxe implements ICorrodible, IAnimatorRepairable {

    protected final ToolMaterialEx toolMaterial;

    public BLSWThrowingAxe(String unlocName, String externalModId, ToolMaterialEx material, float weaponDamage) {
    ...
    public Multimap<String, AttributeModifier> getAttributeModifiers(EntityEquipmentSlot slot, ItemStack stack) {
        return CorrosionHelper.getAttributeModifiers(super.getAttributeModifiers(slot, stack), slot, stack, ItemTool.ATTACK_DAMAGE_MODIFIER,
                DamageHelper.getDamage(DamageHelper.WeaponType.THROWING_AXE, toolMaterial.getAttackDamage()));
    }
