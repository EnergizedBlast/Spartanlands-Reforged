 ...
 */
public class BLSWHammer extends ItemHammer implements ICorrodible, IAnimatorRepairable {

    protected final ToolMaterialEx toolMaterial;

    public BLSWHammer(String unlocName, String externalModId, ToolMaterialEx material, float weaponDamage) {
    ...
    public Multimap<String, AttributeModifier> getAttributeModifiers(EntityEquipmentSlot slot, ItemStack stack) {
        return CorrosionHelper.getAttributeModifiers(super.getAttributeModifiers(slot, stack), slot, stack, ItemTool.ATTACK_DAMAGE_MODIFIER, DamageHelper.getDamage(DamageHelper.WeaponType.HAMMER, toolMaterial.getAttackDamage()));
    }
