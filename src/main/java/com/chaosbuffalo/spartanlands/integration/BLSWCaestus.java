...
public class BLSWCaestus extends ItemCaestus implements ICorrodible, IAnimatorRepairable {
    ...
    public BLSWCaestus(String unlocName, String externalModId, ToolMaterialEx material) {
    ...
    public Multimap<String, AttributeModifier> getAttributeModifiers(EntityEquipmentSlot slot, ItemStack stack) {
        return CorrosionHelper.getAttributeModifiers(super.getAttributeModifiers(slot, stack), slot, stack, ItemTool.ATTACK_DAMAGE_MODIFIER, 2.0F);
    }
