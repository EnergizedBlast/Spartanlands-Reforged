...
public class BLSWGlaive extends ItemGlaive implements ICorrodible, IAnimatorRepairable {
    ...
    public BLSWGlaive(String unlocName, String externalModId, ToolMaterialEx material, float weaponDamage) {
    ...
    public Multimap<String, AttributeModifier> getAttributeModifiers(EntityEquipmentSlot slot, ItemStack stack) {
        return CorrosionHelper.getAttributeModifiers(super.getAttributeModifiers(slot, stack), slot, stack, ItemTool.ATTACK_DAMAGE_MODIFIER, DamageHelper.getDamage(DamageHelper.WeaponType.GLAIVE, toolMaterial.getAttackDamage()));
    }
