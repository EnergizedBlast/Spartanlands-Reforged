...
/**
 * Created by Jacob on 8/11/2018.
 */
public class BLSWKatana extends ItemKatana implements ICorrodible, IAnimatorRepairable {

    protected final ToolMaterialEx toolMaterial;

    public BLSWKatana(String unlocName, String externalModId, ToolMaterialEx material, float weaponDamage) {
    ...
    public Multimap<String, AttributeModifier> getAttributeModifiers(EntityEquipmentSlot slot, ItemStack stack) {
        return CorrosionHelper.getAttributeModifiers(super.getAttributeModifiers(slot, stack), slot, stack, ItemTool.ATTACK_DAMAGE_MODIFIER, DamageHelper.getDamage(DamageHelper.WeaponType.KATANA, toolMaterial.getAttackDamage()));
    }
